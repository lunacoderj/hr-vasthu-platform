...
export const UnlockDrawingModal: React.FC<UnlockDrawingModalProps> = ({
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* ═══ SMART 80vw RESPONSIVE 2-COLUMN MAGAZINE CARD ═══ */}
        <motion.div
          initial={{ scale: 0.95, opacity: 0, y: 20 }}
          animate={{ scale: 1, opacity: 1, y: 0 }}
          exit={{ scale: 0.95, opacity: 0, y: 20 }}
          onClick={(e) => e.stopPropagation()}
          className="relative w-[96vw] sm:w-[92vw] md:w-[86vw] lg:w-[80vw] max-w-5xl max-h-[calc(100vh-6rem)] md:max-h-[820px] bg-white dark:bg-[#12121a] rounded-3xl shadow-2xl border border-amber-300/40 dark:border-white/10 overflow-hidden flex flex-col md:flex-row my-auto"
        >
