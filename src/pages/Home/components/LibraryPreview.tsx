      ...
      <Container>
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-2xl">
            ...
            <Typography variant="h2" className="mb-4 text-white font-serif">Wisdom at Your Fingertips</Typography>
          ...
          <button 
            ...
            className="shrink-0 px-6 py-2.5 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-full font-medium transition-all active:scale-95 flex items-center gap-2 magnetic"
          >
          ...
          {previewBooks.map((book, idx) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] mb-6 perspective-[1000px]">
                <div className="w-full h-full relative transition-transform duration-500 transform-style-3d group-hover:rotate-y-[-10deg] group-hover:scale-105 shadow-[0_15px_35px_rgba(0,0,0,0.5)] group-hover:shadow-[0_20px_50px_rgba(212,114,10,0.15)] rounded-r-2xl rounded-l-sm border border-white/5">
              ...
              <div className="text-center md:text-left">
                <h3 className="font-serif text-2xl font-bold text-white mb-2 group-hover:text-[#d4720a] transition-colors">
                  {book.title}
                </h3>
